...
try {
    global $conn;
    $sql = "SELECT id, lead_id, quotation_number, customer_name, customer_email, customer_phone, delivery_term, terms_of_delivery, approve, is_locked, excel_file FROM quotations ORDER BY id DESC";
