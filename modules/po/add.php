                                    ...
                                    <div class="col-md-1 text-center">
                                        ...
                                        <div class="image-preview" <?php echo empty($item['product_image']) ? 'style="display:none;"' : ''; ?>>
                                            <?php if (!empty($item['product_image'])): ?>
                                                <img src="<?php echo BASE_URL; ?>modules/po/uploads/<?php echo htmlspecialchars($item['product_image']); ?>" alt="Product" style="width:70px;height:70px;object-fit:cover;border:1px solid #ddd;">
                                            <?php else: ?>
