...
try {
    ...
    $stmt_items = $conn->prepare("SELECT *, (SELECT `approval_status` FROM purchase_main WHERE id = purchase_main_id) as main_approval_status FROM purchase_items WHERE purchase_main_id = ? ORDER BY id ASC");
        ...
        <div class="col-md-6">
            ...
            <table class="table table-bordered table-sm">
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($purchase['approval_status']); ?></td>
                </tr>
            </tbody></table>
        </div>
        <div class="col-md-6">
                        ...
                        <tbody>
                            <?php foreach ($items as $index => $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $item_status = $item['item_approval_status'] ?? 'pending';
