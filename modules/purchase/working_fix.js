                ...
                setTimeout(function() {
                    try {
                        ...
                        if (purchaseData && purchaseData.has_purchase && purchaseData.purchase_items) {
                            console.log('=== WORKING FIX: Creating table directly ===');
                            console.log('Purchase items:', purchaseData.purchase_items);
                            ...
                            for (var i = purchaseData.purchase_items.length; i < 10; i++) {
                            ...
                            console.log('=== WORKING FIX: Table created successfully ===');
                        }
                    } catch (e) {
