...
$quotation_number = 'QUOTE-' . date('Y') . '-' . str_pad(rand(1, 99999), 5, '0', STR_PAD_LEFT);
?>
...
<body id="page-top">
                            ...
                            <form id="quotationForm" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="email" class="form-control" id="customer_email" name="customer_email" value="<?php echo htmlspecialchars($_SESSION['supplier_email']); ?>" required>
                                    </div>
                                    <div class="col-md-4">
    ...
    <script>
        ...
        function loadProductsToTable(data) {
            ...
            for (let i = 1; i < data.length; i++) {
                ...
                const product = {
                    ...
                    cbm: '',
                    total_usd: '',
                    image_path: '' // Added image_path for existing products
                };
            ...
            const row = `
                <tr>
                    ...
                    <td><img class="product-preview" width="60" height="60" style="border:1px solid #ddd; object-fit:cover;"
                             src="${product.image_path ? '<?php echo BASE_URL; ?>assets/images/upload/supplier_quotations/' + product.image_path + '?t=' + new Date().getTime() : ''}"
        ...
        function saveQuotation() {
            ...
            formData.append('supplier_id', <?php echo json_encode($supplier_id); ?>);
