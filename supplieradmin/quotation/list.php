...
// Fetch supplier's quotations
try {
    $stmt = $conn->prepare("SELECT * FROM supplier_quotations WHERE supplier_id = ? ORDER BY created_at DESC");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <?php // Always allow edit/delete for supplier quotations ?>
